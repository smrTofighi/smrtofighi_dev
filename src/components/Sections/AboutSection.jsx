    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            About
            <span className="text-purple-500 font-medium">Me</span>
          </motion.h2>
        </motion.div>
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I beleive technology shuold be a bridge that connects people and
                solves real-world promlems. My passion lies in crafting digital
                expriences that are not just functional, but delightful and
              ...
              <div className="grid gap-4">
                {PASSIONS.map((passion, index) => (
                  ...
                  >
                    ...
                    >
                      <passion.icon size={20} className="text-purple-500" />
                    </div>
                    <div>
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              {/* <div className="flex justify-center">
                            <img src={IMG} alt="Mohammad" className="w-28" />
                        </div> */}
              <div className="text-lg font-medium text-purple-600 mt-2">
                Seyyed Mohammad Reza Tofighi
              </div>
            </motion.div>
          </motion.div>
            ...
            <div className="space-y-8">
              {JOURNEY_STEPS.map((step, index) => (
                <motion.div
                  ...
                  whileHover={{ x: 4 }}
                  className="relative flex items-start sapce-x-6 group"
                >
                  {/* TimeLine Dot */}
                  <div
                  ...
                  <div
                    className={`flex-grow p-6 rounded-xl border transition-all duration-300 ${
                      isDarkMode
                        ...
                        : "bg-white/50 border-gray-200 group-hover:border-gray-300 group-hover:bg-white"
                    } backdrop-blur-sm`}
                  >
