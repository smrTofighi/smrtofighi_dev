...
const ContactSection = () => {
  ...
  const [isSubnitting, setIsSubnitting] = useState(false);
          ...
          >
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex-col space-y-6 md:grid-cols-2 gap-6">
                  <TextInput
          ...
          <motion.div
            ...
            className={`max-w-2xl mx-auto p-8 rounded-2xl border ${
              isDarkMode
                ...
                : "bg-gray-50/5-50 border-gray-200"
            }`}
          >
            ...
            <motion.button
              whileHover={{ y: -2, scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`px-6 py-3 rounded-full border font-medium transition-all duration-300 mt-4 ${
                isDarkMode
