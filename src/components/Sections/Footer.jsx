  ...
  const socialLinks = [
    {
      name: "Github",
      icon: FiGithub,
      link: "https://github.com/smrTofighi",
      color: "hover:text-gray-400",
    },
    {
      name: "Instagram",
      icon: FiInstagram,
      link: "https://instagram.com/smrTofighi",
      color: "hover:text-rose-400",
    },
    {
      name: "X",
      icon: FiX,
      link: "https://x.com/smrTofighi",
      color: "hover:text-cyan-400",
    },
    {
      name: "Linkedin",
      icon: FiLinkedin,
      link: "https://linkedin.com/in/smrTofighi",
      color: "hover:text-blue-400",
    },
    {
      name: "Email",
      icon: Mail,
      link: "mailto:mrtofxn@gmail.com",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              >
                © {new Date().getFullYear()} smrTofighi. All rights reserved.{" "}
              </p>
              <p
                className={`text-xs ${
