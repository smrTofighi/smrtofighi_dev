    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        ...
        <div
          className={`absolute top-20 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-5
                ${isDarkMode ? "bg-rose-500" : "bg-rose-400"}`}
        />
      </motion.div>
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Skills &
            <span className="text-purple-500 font-medium"> Technologies</span>
          </motion.h2>
          <motion.p
            variants={itemVariants}
            className={`text-lg ${
          ...
          >
            A comprehensive toolkit for building modren, scalable web
        ...
        >
          {SKILLS_CATEGORY.map((category, cateogryIndex) => (
            <motion.div
              key={category.title}
              variants={itemVariants}
            ...
            >
              ...
              <div className="flex items-center mb-6">
                ...
                >
                  <category.icon size={24} className="text-purple-500" />
                </div>
                <div>
        ...
        >
          {STATS.map((stat,index)=>(
            <motion.div key={stat.label} variants={itemVariants} className="text-center">
              <div className="text-2xl md:text-3xl font-light text-purple-500 mb-2">
                {stat.number}
              </div>
